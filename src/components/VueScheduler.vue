<template>
  <div class="v-cal" id="v-cal">
    <header class="v-cal-header">
      <div class="v-cal-header__actions">
<!--        <div class="actions-right">-->
<!--          <button class="v-cal-button" v-for="(view,index) in availableViews" @click="switchView(view)" :key="index" :class="{ 'v-cal-button&#45;&#45;is-active': activeView === view }" >{{ labels[view] | capitalizeFirstLetter }}</button>-->
<!--        </div>-->
      </div>
...
<!--          </div>-->
        ...
        <div class="actions-left">
            <button class="change-week-button" :disabled="!isPrevAllowed" @click="prev">&#8249;</button>
            <button class="change-week-button" :disabled="!isNextAllowed" @click="next">&#8250;</button>
        </div>
      </div>
    </header>
    <component
